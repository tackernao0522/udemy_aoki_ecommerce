                                ...
                                <table class="table-auto w-full text-left whitespace-no-wrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-3">
                                                <button onclick="location.href='{{ route('admin.owners.edit', $owner->id) }}'" class="text-white bg-indigo-400 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-500 rounded">編集</button>
                                            </td>
                                            <form id="delete_{{ $owner->id }}" method="POST" action="{{ route('admin.owners.destroy', $owner->id) }}">
                                                @method('DELETE')
                                                @csrf
                                                <td class="px-4 py-3">
